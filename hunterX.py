...
async def _set_bot_avatar(ctx, mode: str = None, image: discord.Attachment = None, *, forced_serveronly: bool = False, command_name: str = "setpfpbot"):
    ...
    usage_text = (
        "`svbotpfp` with an attached image."
...
async def setpfpbot(ctx, mode: str = None, image: discord.Attachment = None):
    await _set_bot_avatar(ctx, mode=mode, image=image, command_name="setpfpbot")
...
async def _set_bot_banner(ctx, mode: str = None, image: discord.Attachment = None, *, forced_serveronly: bool = False, command_name: str = "setbnrbot"):
    ...
    usage_text = (
        "`svbotbnr` with an attached image."
        if forced_serveronly
...
async def setbnrbot(ctx, mode: str = None, image: discord.Attachment = None):
    await _set_bot_banner(ctx, mode=mode, image=image, command_name="setbnrbot")
