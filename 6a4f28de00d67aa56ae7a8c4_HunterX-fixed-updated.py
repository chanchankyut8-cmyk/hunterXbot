...
async def _set_bot_avatar(ctx, mode: str = None, *, forced_serveronly: bool = False, command_name: str = "setpfpbot"):
    """
    Usage:
...
@bot.hybrid_command(name="setpfpbot", aliases=["set-bot-pfp", "bot-pfp"], with_app_command=False)
async def setpfpbot(ctx, mode: str = None):
    await _set_bot_avatar(ctx, mode=mode, command_name="setpfpbot")

@bot.hybrid_command(name="svbotpfp", aliases=["server-bot-pfp"], with_app_command=False)
async def svbotpfp(ctx):
    await _set_bot_avatar(ctx, forced_serveronly=True, command_name="svbotpfp")

async def _set_bot_banner(ctx, mode: str = None, *, forced_serveronly: bool = False, command_name: str = "setbnrbot"):
    """
    Usage:
...
@bot.hybrid_command(name="setbnrbot", aliases=["set-bot-banner", "bot-banner"], with_app_command=False)
async def setbnrbot(ctx, mode: str = None):
    await _set_bot_banner(ctx, mode=mode, command_name="setbnrbot")

@bot.hybrid_command(name="svbotbnr", aliases=["server-bot-banner"], with_app_command=False)
async def svbotbnr(ctx):
    await _set_bot_banner(ctx, forced_serveronly=True, command_name="svbotbnr")
...
# ==================== ALLOWED LINK ====================
@bot.hybrid_command(name="allowed-link", aliases=["allowedlink"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
# ==================== PARTNERSHIP POST CHANNEL ====================
@bot.hybrid_command(name="pspost", aliases=["partnership-post", "post-channel"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
# ==================== LEVELING SYSTEM ====================
@bot.group(name="leveling", invoke_without_command=True)
@commands.has_permissions(administrator=True)
...
@bot.hybrid_command(with_app_command=False, name="goodbye", aliases=["goodbye-message"])
@commands.has_permissions(administrator=True)
...
@bot.hybrid_command(with_app_command=False, name="setleavebg", aliases=["set-leave-bg", "leave-bg"])
@commands.has_permissions(administrator=True)
async def setleavebg(ctx, url: str = None):
...
@bot.hybrid_command(with_app_command=False, name="hide")
@commands.has_permissions(manage_channels=True)
async def hide(ctx):
...
@bot.hybrid_command(with_app_command=False, name="unhide")
@commands.has_permissions(manage_channels=True)
...
@bot.hybrid_command(name="setupsv", aliases=["setup-server", "server-template"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
# ==================== AUTO RESPOND ====================
@bot.hybrid_command(name="respond-add", aliases=["autorespondadd"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
@bot.hybrid_command(name="respond-edit", aliases=["autorespondedit"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
# ==================== SET MESSAGE ====================
@bot.hybrid_command(name="set-message", aliases=["setmessage"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
# ==================== BOOST MESSAGE ====================
@bot.hybrid_command(name="boost-message", aliases=["boostmessage"], with_app_command=False)
@commands.has_permissions(administrator=True)
...
@bot.command(name="h!stop", aliases=["music-stop"])
...
@bot.command(name="h!skip", aliases=["music-skip"])
...
@bot.command(name="h!pause", aliases=["music-pause"])
...
@bot.command(name="h!resume", aliases=["music-resume"])
